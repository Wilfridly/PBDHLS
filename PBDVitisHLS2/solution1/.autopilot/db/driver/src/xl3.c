...
void XL3_Set_Layer2_Neurons_CPU(XL3 *InstancePtr, u64 Data) {
    ...
    XL3_WriteReg(InstancePtr->Control_r_BaseAddress, XL3_CONTROL_R_ADDR_LAYER2_NEURONS_CPU_DATA, (u32)(Data));
    XL3_WriteReg(InstancePtr->Control_r_BaseAddress, XL3_CONTROL_R_ADDR_LAYER2_NEURONS_CPU_DATA + 4, (u32)(Data >> 32));
}
...
u64 XL3_Get_Layer2_Neurons_CPU(XL3 *InstancePtr) {
    ...
    Data = XL3_ReadReg(InstancePtr->Control_r_BaseAddress, XL3_CONTROL_R_ADDR_LAYER2_NEURONS_CPU_DATA);
    Data += (u64)XL3_ReadReg(InstancePtr->Control_r_BaseAddress, XL3_CONTROL_R_ADDR_LAYER2_NEURONS_CPU_DATA + 4) << 32;
    return Data;
}
...
void XL3_Set_Layer3_Neurons_CPU(XL3 *InstancePtr, u64 Data) {
    ...
    XL3_WriteReg(InstancePtr->Control_r_BaseAddress, XL3_CONTROL_R_ADDR_LAYER3_NEURONS_CPU_DATA, (u32)(Data));
    XL3_WriteReg(InstancePtr->Control_r_BaseAddress, XL3_CONTROL_R_ADDR_LAYER3_NEURONS_CPU_DATA + 4, (u32)(Data >> 32));
}
...
u64 XL3_Get_Layer3_Neurons_CPU(XL3 *InstancePtr) {
    ...
    Data = XL3_ReadReg(InstancePtr->Control_r_BaseAddress, XL3_CONTROL_R_ADDR_LAYER3_NEURONS_CPU_DATA);
    Data += (u64)XL3_ReadReg(InstancePtr->Control_r_BaseAddress, XL3_CONTROL_R_ADDR_LAYER3_NEURONS_CPU_DATA + 4) << 32;
    return Data;
}
